<template>
  <div class="newsresult_container">
    <div class="newsresult_wrapper" ref="newsResult">
...
export default defineComponent({
  ...
  setup() {
    ...
    bus.on("scrollTop", (data: any) => {
      ...
      for (let i = 1; i < xunhuan; i++) {
        if (data > base + step * i && data < hidebase + hidestep * i) {
    ...
    //     text_month: "15/09",
    //     text_year: "2022",
    //     news_content: "sdffs dgsgsdfdfsdfsdfd ",
    //     title: "",
    //     main_content: "",
    //   },
    //   {
    ...
    //     text_year: "2022",
    //     news_content:
    //       "今年有滿記手作「家湯圓」同您過中秋~~ 幼滑流心芝麻同花生餡料!  全線滿記有售… ",
    //   },
    //   {
    //     index: "3",
    //     img: "../../../assets/img/30.jpg",
