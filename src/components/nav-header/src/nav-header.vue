    ...
    <ul>
      ...
      <li @click="jump('/home/shoppingcart')">
        <div>
          ...
          <br />
          <div class="nav_ch_txt"><img src="../../../assets/img/shoppingcart_empty.svg" alt="" style="width:20px;margin-right:2px"><div  class="circle">1</div><div style="padding:5px 0px 0px 3px">购物车</div></div>
        </div>
        <div class="curveline"></div>
      </li>
      <li>
